...
def eval_similarity(predictor, similarity_func: str, datasrc: str, gt_path: str, prop_dir: str, opt_flow_dir: str,
    ...
    num_correct, num_evaled = 9609, 11453
    num_correct_known, num_evaled_known = 8281, 9564
    num_correct_neighbor, num_evaled_neighbor = 137, 188
    num_correct_unknown, num_evaled_unknown = 1191, 1701
    ...
    for vidx, video in enumerate(videos[93:]):
        similarity_record = dict()
        print("{}/{} Process Videos {}/{}".format(vidx + 93, len(videos), datasrc, video))
