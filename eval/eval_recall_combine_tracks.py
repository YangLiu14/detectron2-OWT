...
def make_plot(output_dir, export_dict, plot_title, x_vals, linewidth=5):
    ...
    plt.xlabel("percentage of objects in a track that are detected")
    plt.ylabel("Recall")
    ax.set_ylim([0.0, 1.0])
...
"""
python eval_recall_combine_tracks.py \
    --csv_folder /storage/user/liuyang/Recall_eval/tracks_NonOverlapArea/ \
    --split known
"""