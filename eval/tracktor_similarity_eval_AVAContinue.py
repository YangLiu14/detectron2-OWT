...
def eval_similarity(predictor, similarity_func: str, datasrc: str, gt_path: str, prop_dir: str, opt_flow_dir: str,
    ...
    num_correct, num_evaled = 8873, 10346
    num_correct_known, num_evaled_known = 8072, 9087
    num_correct_neighbor, num_evaled_neighbor = 118, 189
    num_correct_unknown, num_evaled_unknown = 683, 1070
    ...
    for vidx, video in enumerate(videos[108:]):
        similarity_record = dict()
        print("{}/{} Process Videos {}/{}".format(vidx + 108, len(videos), datasrc, video))
