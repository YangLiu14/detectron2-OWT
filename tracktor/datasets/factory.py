...
from tao_wrapper import TaoWrapper
...
for split in ['train', 'val', 'test']:
    for datasrc in ['ArgoVerse', 'AVA', 'BDD', 'Charades', 'LaSOT', 'YFCC100M', 'HACS']:
        name = f'TAO_{split}_{datasrc}'
        _sets[name] = (lambda *args, split=split: TaoWrapper(split, datasrc, *args))
