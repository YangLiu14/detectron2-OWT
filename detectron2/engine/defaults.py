...
class TracktorPredictor(DefaultPredictor):
    """
    ...
    def __call__(self, original_image, boxes):
        ...
        Args:
            original_image (np.ndarray): an image of shape (H, W, C) (in BGR order).
            boxes (np.ndarray): array of bounding boxes in the format of [x1, y1, x2, y2]. Shape (N, 4).
        ...
        with torch.no_grad():  # https://github.com/sphinx-doc/sphinx/issues/4258
            ...
            # Apply the same transform to the image and boxes
            ...
            new_boxes = Instances(image_size=(transform.new_h, transform.new_w))
